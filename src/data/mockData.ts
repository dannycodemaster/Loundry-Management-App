...
export const mockOrders: Order[] = [
  {
    ...
    garments: [
      { id: 'g1', type: 'Suit', quantity: 2, service: 'dry-cleaning', price: 5000 },
      { id: 'g2', type: 'Shirt', quantity: 5, service: 'washing', price: 500 },
    ],
  ...
  },
  {
    ...
    garments: [
      { id: 'g3', type: 'Gown', quantity: 3, service: 'dry-cleaning', price: 4000 },
  ...
  },
  {
    ...
    garments: [
      { id: 'g5', type: 'Trousers', quantity: 4, service: 'washing', price: 800 },
      { id: 'g6', type: 'T-shirt', quantity: 6, service: 'washing', price: 400 },
    ],
  ...
  },
  {
    ...
    garments: [
      { id: 'g7', type: 'Jacket', quantity: 1, service: 'dry-cleaning', price: 6000 },
    ],
  ...
  },
  {
    ...
    garments: [
      ...
      { id: 'g10', type: 'Gown', quantity: 1, service: 'dry-cleaning', price: 4000 },
    ],
...
export const defaultPricing: PricingConfig[] = [
  { garmentType: 'T-shirt', service: 'washing', price: 400 },
  { garmentType: 'T-shirt', service: 'ironing', price: 200 },
  { garmentType: 'T-shirt', service: 'dry-cleaning', price: 800 },
  { garmentType: 'Shirt', service: 'washing', price: 500 },
  { garmentType: 'Shirt', service: 'ironing', price: 300 },
  { garmentType: 'Shirt', service: 'dry-cleaning', price: 1000 },
  { garmentType: 'Trousers', service: 'washing', price: 800 },
  { garmentType: 'Trousers', service: 'ironing', price: 500 },
  { garmentType: 'Trousers', service: 'dry-cleaning', price: 1500 },
  { garmentType: 'Gown', service: 'washing', price: 2000 },
  { garmentType: 'Gown', service: 'ironing', price: 1000 },
  { garmentType: 'Gown', service: 'dry-cleaning', price: 4000 },
  { garmentType: 'Native (Up & Down)', service: 'washing', price: 1500 },
  { garmentType: 'Native (Up & Down)', service: 'ironing', price: 800 },
  { garmentType: 'Native (Up & Down)', service: 'dry-cleaning', price: 3000 },
  { garmentType: 'Suit', service: 'washing', price: 3000 },
  { garmentType: 'Suit', service: 'ironing', price: 1500 },
  { garmentType: 'Suit', service: 'dry-cleaning', price: 5000 },
  { garmentType: 'Jacket', service: 'washing', price: 2500 },
  { garmentType: 'Jacket', service: 'ironing', price: 1200 },
  { garmentType: 'Jacket', service: 'dry-cleaning', price: 6000 },
  { garmentType: 'Others', service: 'washing', price: 1000 },
  { garmentType: 'Others', service: 'ironing', price: 500 },
  { garmentType: 'Others', service: 'dry-cleaning', price: 2000 },
];
